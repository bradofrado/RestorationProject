...
export const pageRouter = createTRPCRouter({
  ...
  getPageNames: publicProcedure.query(async ({ ctx }) => {
  ...
  createPage: editableProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      await ctx.logger.info(
        `CreatePage: ${JSON.stringify(input)}`,
        ctx.session.user
      );
  ...
  updatePage: editableProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      await ctx.logger.info(
        `UpdatePage: ${JSON.stringify(input)}`,
        ctx.session.user
      );
  ...
  createSetting: editableProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      await ctx.logger.info(
        `CreateSetting: ${JSON.stringify(input)}`,
        ctx.session.user
      );
  ...
  updateSetting: editableProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      await ctx.logger.info(
        `UpdateSetting: ${JSON.stringify(input)}`,
        ctx.session.user
      );
  ...
  updateSettingOrder: editableProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      await ctx.logger.info(
        `UpdateSettingOrder: ${JSON.stringify(input)}`,
        ctx.session.user
      );
