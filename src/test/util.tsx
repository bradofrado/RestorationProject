    ...
    items: [
      {
        ...
        links: [
          {
            link: 'https://www.josephsmithpapers.org/paper-summary/lucy-mack-smith-history-1845/112',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://www.josephsmithpapers.org/paper-summary/history-1838-1856-volume-a-1-23-december-1805-30-august-1834/10',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://www.josephsmithpapers.org/paper-summary/history-circa-summer-1832/5',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://www.josephsmithpapers.org/paper-summary/revelation-book-1/3',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://catalog.churchofjesuschrist.org/assets?id=cbff7497-0764-4f7d-9aec-702b5f9b8f27&crate=0&index=0',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://www.josephsmithpapers.org/paper-summary/history-circa-summer-1832/6#source-note',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://www.churchofjesuschrist.org/study/scriptures/pgp/js-h/1?lang=eng',
          },
        ],
        type: 'EXACT',
        x: null,
    ...
    items: [
      {
        ...
        links: [
          {
            link: 'https://user.xmission.com/~research/central/palmyrafreeman.pdf',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://archive.org/details/TheSaintsHerald_Volume_26_1879/page/n287/mode/2up?view=theater',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://digitalcommons.usu.edu/cgi/viewcontent.cgi?article=1065&context=mormonhistory',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://contentdm.lib.byu.edu/digital/collection/BOMP/id/334',
          },
        ],
        type: 'EXACT',
        x: null,
      ...
      },
      {
        ...
        links: [
          {
            link: 'https://archive.org/details/threewitnesses/page/163/mode/2up',
          },
        ],
        type: 'EXACT',
        x: null,
...
export const itemsSorted = categories
  .reduce<TimelineItemStandalone[]>((prev, curr) => {
    ...
    settings: [
      ...
      },
      {
        ...
        data: {
          content: 'custom',
          properties:
            '{"margin":0,"color":"#D87D7DFF","group":true,"items":["Here","are","some","List","items"]}',
        },
        pageId: '1',
        component: 'List',
        order: 5,
      ...
      },
      {
        ...
        data: {
          ...
          properties:
            '{"margin":0,"color":"#D87D7DFF","group":true,"items":[]}',
        },
        pageId: '1',
        component: 'List',
        order: 7,
